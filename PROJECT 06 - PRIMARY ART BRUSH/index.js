...
primaryColor.addEventListener("click", function () {
	background.style.cssText = `background: url('./colors/primary-colors.png') no-repeat 95% / cover`;
...
red.addEventListener("click", function () {
	background.style.cssText = `background: url('./colors/red.png') no-repeat 95% / cover`;
	h1.textContent = "Red";
...
yellow.addEventListener("click", function () {
	background.style.cssText = `background: url('./colors/yellow.png') no-repeat 95% / cover`;
	h1.textContent = "Yellow";
	p[0].textContent = "rgb(255, 255, 0)";
	p[1].textContent = "hsl(60, 100, 50)";
	p[2].textContent = "#00ff00";
});

blue.addEventListener("click", function () {
	background.style.cssText = `background: url('./colors/blue.png') no-repeat 95% / cover`;
	h1.textContent = "Blue";
